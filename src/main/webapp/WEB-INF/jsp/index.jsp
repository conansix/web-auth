...
<script src="<%=request.getContextPath()%>/frame/bower_components/raphael/raphael-min.js"></script>
<script src="<%=request.getContextPath()%>/frame/bower_components/morrisjs/morris.min.js"></script>
<script src="<%=request.getContextPath()%>/frame/js/morris-data.js"></script>
